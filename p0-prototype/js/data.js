...
var CONFIG = (function () {
  ...
  var AREA_SPECS = [
    ...
    /* ===== 瓦当镇（章1 · 1-15） ===== */
    { id: 'qingshiwai', name: '丹阳林道', type: 'field', region: '凡界', ch: 1, city: 'qingshi', lvMin: 1,  lvMax: 3,  unlock: 1,  pos: [11, 26], desc: '镇外荒地，蝙蝠野狗出没。', monsters: ['蝙蝠', '杂毛野狗'], elite: ['杂毛野狗'] },
    { id: 'huangfenye', name: '乱葬岗',  type: 'field', region: '凡界', ch: 1, city: 'qingshi', lvMin: 1,  lvMax: 3,  unlock: 1,  pos: [7, 30],  desc: '荒坟连片，阴气沉沉。', monsters: ['杂毛野狗', '蝙蝠'], elite: ['杂毛野狗'] },
    ...
    { id: 'luolanggu',  name: '落马后山',   type: 'field', region: '凡界', ch: 1, city: 'qingshi', lvMin: 6,  lvMax: 8,  unlock: 4,  pos: [23, 27], desc: '谷地狼群伏莽，妖气渐浓。', monsters: ['刀盾狼兵', '铁弓狼兵', '锤盾狼兵'], elite: ['刀盾狼兵'] },
    { id: 'shinherzongx', name: '十二陵下层', type: 'cave', region: '凡界', ch: 1, city: 'qingshi', lvMin: 1, lvMax: 15, unlock: 2, pos: [12, 37], desc: '魂冢下层，双镰与冢中精怪横立。', monsters: ['战双镰', '杂毛野狗', '蝙蝠', '黄毛野狗', '低等刀盾狼精', '低等锤盾狼精'], elite: ['战双镰'], boss: ['猪精十夫长'] },
    { id: 'shinherzong_t', name: '十二陵上层', type: 'cave', region: '凡界', ch: 1, city: 'qingshi', lvMin: 1, lvMax: 15, unlock: 3, pos: [16, 39], desc: '魂冢上层，深处盘踞冢中妖将。', monsters: ['战双镰', '杂毛野狗', '蝙蝠', '黄毛野狗', '低等刀盾狼精', '低等锤盾狼精', '低等长枪狼兵'], elite: ['猪精十夫长'] },

    /* ===== 洛阳城（章2-3 · 10-32） ===== */
    { id: 'xiehuntai',  name: '鬼星台',   type: 'ghost', region: '凡界', ch: 2, city: 'luoxiacheng', lvMin: 10, lvMax: 25, unlock: 10, pos: [27, 23], desc: '游魂汇聚的凶台。', monsters: ['刀盾狼兵魂魄', '锤盾狼精魂魄', '刀盾狼精魂魄', '锤盾狼兵魂魄', '铁弓狼精魂魄', '铁弓狼兵魂魄', '长枪狼精魂魄', '长枪狼兵魂魄', '飞刀猫妖魂魄', '飞刀猫兵魂魄', '铁爪猫妖魂魄', '铁爪猫兵魂魄', '长枪猫妖魂魄', '长枪猫兵魂魄', '傀儡魂魄', '野狗魂魄'], elite: ['飞刀猫妖魂魄'] },
    { id: 'qingxijian', name: '九曲溪谷',   type: 'field', region: '凡界', ch: 2, city: 'luoxiacheng', lvMin: 12, lvMax: 18, unlock: 10, pos: [29, 27], desc: '溪涧潺潺，狼精猫兵出没。', monsters: ['幡旗狼精', '铁弓狼精', '长枪狼精', '铁爪猫兵', '飞刀猫兵'], elite: ['铁爪猫兵'] },
    { id: 'luoshui',    name: '洛水南岸', type: 'field', region: '凡界', ch: 2, city: 'luoxiacheng', lvMin: 16, lvMax: 23, unlock: 12, pos: [35, 25], desc: '洛水南岸，猫族弓手盘桓。', monsters: ['长枪猫兵', '长枪猫妖', '铁爪猫兵', '铁爪猫妖', '飞刀猫兵', '飞刀猫妖'], elite: ['飞刀猫妖'] },
    { id: 'yaozuyingdi',name: '妖族营地', type: 'field', region: '凡界', ch: 2, city: 'luoxiacheng', lvMin: 20, lvMax: 27, unlock: 14, pos: [31, 31], desc: '妖兵扎营之处，号角声震。', monsters: ['长枪猫妖', '铁爪猫妖', '飞刀猫妖', '号角猫妖', '红袍狐妖'], elite: ['号角猫妖'] },
    { id: 'wuqiao',     name: '午桥庄', type: 'field', region: '凡界', ch: 3, city: 'luoxiacheng', lvMin: 20, lvMax: 29, unlock: 16, pos: [25, 34], desc: '荒废村庄与古墓，妖兽横行。', monsters: ['长枪猫妖', '铁爪猫妖', '飞刀猫妖', '号角猫妖', '高等锤盾狼兵', '盗墓贼'], elite: ['盗墓贼'] },
    ...
    { id: 'yaohubuluo', name: '狐妖部落', type: 'field', region: '凡界', ch: 4, city: 'hanyuguan', lvMin: 39, lvMax: 54, unlock: 34, pos: [47, 16], desc: '北地妖狐聚落的腹地。', monsters: ['狐狸精骑兵', '披甲鹿', '蓝袍狐妖', '狐狸小校', '狐狸斥候'], elite: ['披甲鹿'] },
    ...
    { id: 'yaohudong',  name: '妖狸洞',   type: 'cave', region: '凡界', ch: 5, city: 'yanyud', lvMin: 41, lvMax: 46, unlock: 45, pos: [57, 28], desc: '狐妖地底巢穴，巨人奴役出没。', monsters: ['狐狸强弩手', '狐狸小校', '狐狸斥候', '巨人战士'], elite: ['巨人战士'] },
    { id: 'manjurengu', name: '巨人部落', type: 'field', region: '凡界', ch: 5, city: 'yanyud', lvMin: 46, lvMax: 60, unlock: 46, pos: [63, 26], desc: '蛮族巨人盘踞的深谷。', monsters: ['巨人战士', '巨人投掷手', '巨人法师', '板斧蛮兵', '钢叉蛮兵', '冰羌族勇士', '冰羌族投掷手', '冰羌族巫傩'], elite: ['巨人法师'] },
    { id: 'shibapan',   name: '十八盘',   type: 'field', region: '凡界', ch: 5, city: 'yanyud', lvMin: 46, lvMax: 58, unlock: 46, pos: [60, 31], desc: '层叠盘道的峡谷险径。', monsters: ['巨人战士', '巨人投掷手', '巨人法师', '斧头蛮子', '草叉蛮子'], elite: ['巨人投掷手'] },
    ...
    { id: 'yanhuodao',  name: '厌火岛',   type: 'field', region: '凡界', ch: 6, city: 'xuandug', lvMin: 61, lvMax: 66, unlock: 56, pos: [66, 16], desc: '烈焰吞吐的凶险岛礁。', monsters: ['火把小校', '长棍小校', '嗜火小妖头目', '嗜火小妖细作', '火弹小妖头目', '长棍小妖'], elite: ['嗜火小妖头目'] },
    { id: 'luoxingwan', name: '落星湾',   type: 'field', region: '凡界', ch: 6, city: 'xuandug', lvMin: 60, lvMax: 65, unlock: 55, pos: [58, 22], desc: '流星坠落的港湾，虎族称雄。', monsters: ['火把小妖', '长棍小妖', '火弹小妖', '火把小校', '长棍小校', '火弹小校', '雌虎鲛', '虎王卫队'], elite: ['虎王卫队'] },
    { id: 'pingazhen',  name: '平阿镇',   type: 'field', region: '凡界', ch: 6, city: 'xuandug', lvMin: 60, lvMax: 65, unlock: 55, pos: [64, 23], desc: '被倭猴劫掠的平地小镇。', monsters: ['倭猴', '木锨倭猴', '马勺倭猴', '草叉倭猴', '单刀倭猴'], elite: ['单刀倭猴'] },
    { id: 'shangyangyuan', name: '殇阳平原', type: 'field', region: '凡界', ch: 6, city: 'xuandug', lvMin: 60, lvMax: 65, unlock: 55, pos: [69, 25], desc: '古战场殇阳之原，幽魂不散。', monsters: ['倭猴', '木锨倭猴', '马勺倭猴', '草叉倭猴', '幽魂', '倭猴头目', '单刀倭猴', '倭猴药师'], elite: ['倭猴头目'] },
    ...
    { id: 'dinghushan', name: '鼎湖山',   type: 'field', region: '凡界', ch: 6, city: 'xuandug', lvMin: 66, lvMax: 69, unlock: 59, pos: [70, 13], desc: '鼎湖山巅，魔猿啸聚。', monsters: ['大棒魔猿', '大棒魔猿头目', '双锤魔猿', '双锤魔猿头目'], elite: ['双锤魔猿头目'] },
    ...
    { id: 'naiheqiao',  name: '奈何桥',   type: 'ghost', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 71, lvMax: 75, unlock: 70, pos: [76, 26], desc: '奈何桥上，地狱树盘根错节。', monsters: ['钢叉地府兵卒', '锤盾地府兵卒', '灯笼铁链妖', '双钩铁链妖', '灯笼冥府小厮', '长枪冥府小厮', '大棒冥府小厮', '地狱树'], elite: ['地狱树'] },
    { id: 'youminggumu',name: '巴蜀古墓', type: 'cave', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 71, lvMax: 76, unlock: 70, pos: [78, 30], desc: '冥府古墓，亡魂与兵卒杂处。', monsters: ['钢叉地府兵卒', '锤盾地府兵卒', '灯笼铁链妖', '双钩铁链妖', '灯笼冥府小厮', '长枪冥府小厮', '大棒冥府小厮', '地狱树', '地府断魂兽'], elite: ['大棒冥府小厮'] },
    { id: 'huangquanlu',name: '黄泉路',   type: 'ghost', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 73, lvMax: 76, unlock: 71, pos: [70, 28], desc: '黄泉幽径，铁链妖与断魂拦路。', monsters: ['灯笼铁链妖', '双钩铁链妖', '大棒铁链妖', '灯笼冥府小厮', '长枪冥府小厮', '大棒冥府小厮', '刀盾冥府小厮', '地狱断魂'], elite: ['大棒铁链妖'], boss: ['地狱断魂'] },
    { id: 'yunmeng',    name: '云梦泽', type: 'field', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 73, lvMax: 83, unlock: 72, pos: [82, 34], desc: '冥泽万顷，罗刹与鳄鱼精潜藏。', monsters: ['钢叉罗刹', '锤盾罗刹', '地府断魂兽', '大刀鳄鱼精', '蜥蜴精刀兵', '蜥蜴精斧卫', '弩箭蜥蜴精'], elite: ['锤盾罗刹'], boss: ['大刀鳄鱼精'] },
    { id: 'heiyishan',  name: '黑翼山',   type: 'ghost', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 77, lvMax: 79, unlock: 74, pos: [74, 32], desc: '黑翼蝙蝠蔽日的冥山。', monsters: ['钢叉罗刹', '锤盾罗刹', '牛首阿旁', '马面阿旁', '暗翼蝙蝠', '短翼蝙蝠', '短翼狐蝠'], elite: ['牛首阿旁'], boss: ['暗翼蝙蝠'] },
    { id: 'wangxiangtai',name: '望乡台',  type: 'ghost', region: '冥界', ch: 7, city: 'youmingdu', lvMin: 77, lvMax: 79, unlock: 74, pos: [80, 28], desc: '亡魂回望故乡的高台。', monsters: ['钢叉罗刹', '锤盾罗刹', '牛首阿旁', '马面阿旁', '冥府亡魂', '冥府长枪兵', '冥府刀盾兵', '冥府弓箭兵'], elite: ['牛首阿旁'] },

    /* ===== 蚩炎城（章8 · 75-95） ===== */
    { id: 'donghai',    name: '东海',     type: 'field', region: '北荒', ch: 8, city: 'chiyouzhong', lvMin: 75, lvMax: 82, unlock: 75, pos: [61, 32], desc: '东海水畔，穿山甲监工凿山。', monsters: ['枪盾穿山甲', '长枪穿山甲', '锤盾穿山甲', '双钩穿山甲', '穿山甲苦力', '民兵亡魂', '穿山甲监工'], elite: ['穿山甲监工'] },
    { id: 'laoshan',    name: '崂山',     type: 'field', region: '北荒', ch: 8, city: 'chiyouzhong', lvMin: 75, lvMax: 85, unlock: 75, pos: [56, 30], desc: '崂山幽处，贪心魂魄游荡。', monsters: ['高级枪盾穿山甲', '高级长枪穿山甲', '高级锤盾穿山甲', '高级双钩穿山甲', '贪心魂魄', '穿山甲苦力', '穿山甲监工'], elite: ['贪心魂魄'] },
    { id: 'qianzhong',  name: '黔中古墟', type: 'field', region: '北荒', ch: 8, city: 'chiyouzhong', lvMin: 82, lvMax: 86, unlock: 78, pos: [66, 37], desc: '黔中上古废墟，毒蜂巨兽横行。', monsters: ['巨型毒蜂', '嗜血红魔', '双斧青牛妖', '蜂妖', '象怪首领'], elite: ['象怪首领'] },
    { id: 'taoyuan',    name: '桃源浣溪', type: 'field', region: '北荒', ch: 8, city: 'chiyouzhong', lvMin: 83, lvMax: 87, unlock: 79, pos: [52, 36], desc: '世外桃源，桃树精与蜂妖守护。', monsters: ['巨型毒蜂', '桃树精', '双斧青牛妖', '蜂妖', '蜂妖头领'], elite: ['桃树精'] },
    ...
    { id: 'hujuguan',   name: '徐州城关',   type: 'field', region: '北荒', ch: 8, city: 'chiyouzhong', lvMin: 90, lvMax: 95, unlock: 85, pos: [68, 36], desc: '虎妖扼守的雄关要道。', monsters: ['长枪虎兵', '短矛虎兵', '刀盾虎兵', '长枪虎妖', '短矛虎妖', '刀盾虎妖'], elite: ['刀盾虎妖'] },
